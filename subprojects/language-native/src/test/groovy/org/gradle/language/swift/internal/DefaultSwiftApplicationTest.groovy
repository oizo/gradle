...
class DefaultSwiftApplicationTest extends Specification {
    def "has debug and release variants"() {
        expect:
        def app = new DefaultSwiftApplication("main", Mock(ProjectLayout), Stub(ProviderFactory), TestUtil.objectFactory(), Stub(FileOperations), Stub(ConfigurationContainer))
