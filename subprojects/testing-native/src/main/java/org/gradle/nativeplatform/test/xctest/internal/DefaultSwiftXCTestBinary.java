...
public class DefaultSwiftXCTestBinary extends DefaultSwiftBinary implements SwiftXCTestBinary {
    ...
    @Inject
    public DefaultSwiftXCTestBinary(String name, ProjectLayout projectLayout, ProviderFactory providerFactory, ObjectFactory objectFactory, Provider<String> module, boolean debuggable, boolean optimized, boolean testable, FileCollection source, ConfigurationContainer configurations, Configuration implementation) {
